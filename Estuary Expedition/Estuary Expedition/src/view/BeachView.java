		...
		try {
			...
			for (Wave w : this.beach.waveArr) { // different speeds will produce
				...
				if (w.getSpeed() == 1 && this.beach.boat.getSpeed() < 0) {
					w.waveType = "Large";
					g.drawImage(waveImages[2], beach.boat.xCoord, w.yCoord, null);
				}
				...
				if (w.getSpeed() == 2 && this.beach.boat.getSpeed() < 0) {
					w.waveType = "Medium";
					g.drawImage(waveImages[1], beach.boat.xCoord, w.yCoord, null);
				}
				...
				if (w.getSpeed() == 3 && this.beach.boat.getSpeed() < 0) {
					w.waveType = "Small";
					g.drawImage(waveImages[0], beach.boat.xCoord, w.yCoord, null);
				}
