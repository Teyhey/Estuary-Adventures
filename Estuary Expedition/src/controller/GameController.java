...
public class GameController extends GameModel{
	...
	public GameController(){
		super();
		this.controller = new MouseAdapter(){public void mousePressed (MouseEvent e){
			int x = e.getX();
			int y = e.getY();
			if ((x >= menuView.getMazeButtonX() && x <= menuView.getMazeButtonX() + menuView.getButtonSide())	
					&& (y >= menuView.getMazeButtonY() && y <= menuView.getMazeButtonY() + menuView.getButtonSide() && gameState == "Menu")){
			...
			if ((x >= menuView.getBeachButtonX() && x <= menuView.getBeachButtonX() + menuView.getButtonSide())	
					&& (y >= menuView.getBeachButtonY() && y <= menuView.getBeachButtonY() + menuView.getButtonSide() && gameState == "Menu")){
			...
			if ((x >= menuView.getCubeButtonX() && x <= menuView.getCubeButtonX() + menuView.getButtonSide())	
					&& (y >= menuView.getCubeButtonY() && y <= menuView.getCubeButtonY() + menuView.getButtonSide() && gameState == "Menu")){
