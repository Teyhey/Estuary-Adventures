	...
	public void draw(Graphics g){
		try {
			...
			if (maze.getCurrDistance() < maze.getDistance()){
				...
				g.setColor(back);
				g.fillRect(1005, 695, healthWidth + 10, healthHeight + 10);
				double currHealth = (double) (this.maze.player.health/500.0000);
				int currHealthWidth = (int) (currHealth * healthWidth);
				Color health = new Color (255, 0, 0);
				g.setColor(health);
				g.fillRect(1010, 700, currHealthWidth, healthHeight);
